    ...
    <>
      ...
      >
        <MainPageContentArticle lang="pt-br">
          <ArticleTitle>Hortifruti</ArticleTitle>
          <Content className="section-content">
            ...
            <ContentParagraph>
              Além disso, o hortifrúti também pode desempenhar um papel crucial
              na promoção da sustentabilidade e na redução do desperdício de
              alimentos. Ao obter produtos frescos cultivados localmente, os
              supermercados podem reduzir sua pegada de carbono, apoiar
              agricultores locais e minimizar o desperdício de alimentos por
              meio de armazenamento e manuseio adequados.
            </ContentParagraph>
          </Content>
          <section aria-labelledby="referência">
            <SectionTitle id="#referências">
              ...
              <dl>
                ...
                <DescriptionDefinition>
                  <p>
                    ...
                    hortifruti, tornando essencial priorizar a oferta de uma
                    ampla variedade de opções para satisfazer a demanda dos
